...
namespace Nailpod.Data.Services
{
    public interface IDataService : IDisposable
    {
        ...
        Task<Place> GetPlaceAsync(long id);
        Task<IList<Place>> GetPlacesAsync(int skip, int take, DataRequest<Place> request);
        Task<IList<Place>> GetPlaceKeysAsync(int skip, int take, DataRequest<Place> request);
        Task<int> GetPlacesCountAsync(DataRequest<Place> request);
        Task<int> UpdatePlaceAsync(Place place);
        Task<int> DeletePlacesAsync(params Place[] places);
