...
namespace Nailpod
{
    static public class Startup
    {
        ...
        {
            AppCenter.Start("a4c67233-c6d7-434b-b5ca-556d088613c1", typeof(Analytics), typeof(Crashes));
        ...
        private static void ConfigureNavigation()
        {
            ...
            NavigationService.Register<PlacesViewModel, PlacesView>();
            NavigationService.Register<PlaceDetailsViewModel, PlaceView>();
