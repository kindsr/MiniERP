...
namespace Nailpod
{
    public class ServiceLocator : IDisposable
    {
        ...
        static public void Configure(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IPlaceService, PlaceService>();
            ...
            serviceCollection.AddTransient<PlacesViewModel>();
            serviceCollection.AddTransient<PlaceDetailsViewModel>();
