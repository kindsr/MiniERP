...
namespace Nailpod.Services
{
    public class SettingsService : ISettingsService
    {
        ...
        {
            get => AppSettings.Current.MariaConnectionString;
            set => AppSettings.Current.MariaConnectionString = value;
        }
        ...
        public async Task<Result> ValidateConnectionAsync(string connectionString, DataProviderType dataProvider)
        {
            var dialog = new ValidateConnectionView(connectionString, dataProvider);
            var res = await dialog.ShowAsync();
            switch (res)
            {
                case ContentDialogResult.Secondary:
