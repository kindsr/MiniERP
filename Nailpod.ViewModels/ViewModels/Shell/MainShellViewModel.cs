...
namespace Nailpod.ViewModels
{
    public class MainShellViewModel : ShellViewModel
    {
        ...
        private readonly NavigationItem PlacesItem = new NavigationItem(0xE819, "Places", typeof(PlacesViewModel));
        ...
        public async void NavigateTo(Type viewModel)
        {
            switch (viewModel.Name)
            {
                ...
                case "ProductsViewModel":
                    ...
                    break;
                case "MachinesViewModel":
                    NavigationService.Navigate(viewModel, new ProductListArgs());
                    break;
                case "PlacesViewModel":
                    NavigationService.Navigate(viewModel, new PlaceListArgs());
                    break;
